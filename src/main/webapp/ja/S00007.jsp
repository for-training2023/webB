...
<%
	...
	if ("1".equals(request.getAttribute("rating_from_error"))) {
...
const nickname_type_radio1 = document.getElementsByName("nickname_type_radio")
		...
		<!--条件divをまとめるdiv(contents)-->
				...
				<table>
					<tr>
						...
						<td class="value">
							<table class="radio_base">
								<tr>
									<td>
										<input type="radio" onclick="checkAll()" id="id_nickname_radio1" value="1" name="nickname_radio"  class="onOffRadio" <%= nickname_radio1 %>>
										<span class="radio_label">指定</span>
									</td>
									<td>
										<input type="radio" id="id_nickname_radio2" name="nickname_radio" value="2" class="onOffRadio" <%= nickname_radio2 %>>
					...
					<tr>
						<td class="value">
							<table class="radio_base">
								<tr>
									<td><input type="radio"  id="id_nickname_type_radio1" name="nickname_type_radio"
										value="3" <%= nickname_type_radio1 %>><span class="radio_label">あいまい</span></td>
									<td><input type="radio" id="id_nickname_type_radio2" name="nickname_type_radio"
										value="4" <%= nickname_type_radio2 %>><span class="radio_label">完全一致</span>
									</td>
								</tr>
				...
				<table>
					<tr>
						...
						<td class="value">
							<table class="radio_base">
								<tr>
									<td><input type="radio" id="id_joined_date_radio1" name="joined_date_radio" value="1"
										class="onOffRadio" <%= joined_date_radio1 %>><span class="radio_label">指定</span>
									</td>
									<td><input type="radio"  id="id_joined_date_radio2" name="joined_date_radio" value="2"
					...
					<tr>
						<td class="value"><input type="date" id="id_joined_date_from" name="joined_date_from"
							value="<%= joined_date_from%>"> <br> ～ <br> <input
							type="date" id="id_joined_date_to" name="joined_date_to" value="<%= joined_date_to%>"></td>
					</tr>
				</table>
			</div>
			</div>			
				...
				<table>
					<tr>
						...
						<td class="value">
							<table class="radio_base">
								<tr>
									<td><input type="radio"  id="id_gender_radio1" name="gender_radio" value="1"
										class="onOffRadio" <%= gender_radio1 %> ><span class="radio_label">指定</span>
									</td>
									<td><input type="radio" id="id_gender_radio2" name="gender_radio" value="2"
					...
					<tr>
						<td class="value"><select id="id_gender" name="gender" tabindex="10">
				...
				<table>
					<tr>
						...
						<td class="value">
							<table class="radio_base">
								<tr>
									<td><input type="radio" id="id_birthday_radio1" name="birthday_radio" value="1"
										class="onOffRadio" <%= birthday_radio1 %> ><span
										class="radio_label">指定</span></td>
									<td><input type="radio" id="id_birthday_radio2" name="birthday_radio" value="2"
										class="onOffRadio" <%= birthday_radio2 %>><span class="radio_label">指定なし</span></td>
								</tr>
							</table>
						</td>
					</tr>
					<tr>
						<td class="value"><input type="date" id="id_birthday_from" name="birthday_from"
							value="<%= birthday_from%>"> <br> ～ <br> <input
							type="date" id="id_birthday_to"  name="birthday_to" value="<%= birthday_to%>"></td>
					</tr>
				</table>
			</div>
			</div>
			...
			<div class="input_table">
				<table>
							...
							<table class="radio_base">
								<tr>
									<td><input type="radio" id="listener_count_radio1" name="listener_count_radio"
										value="1" class="onOffRadio" <%= listener_count_radio1 %>><span class="radio_label">指定</span>
									</td>
					...
					<tr>
						<td class="value"><input type="text" id="listener_count_from" name="listener_count_from" value="<%= listener_count_from %>" maxlength="8"> <br>
							～ <br> <input type="text" name="listener_count_to"  value="<%= listener_count_to %>"
							maxlength="8"></td>
					</tr>
				</table>
			</div>
			...
			<!-- 言語 -->
			<div id="jouken_language_type" class="jouken<%= language_type_is_error %>">
			<div class="input_table">
				<table>
					<tr>
						<td class="label">言語</td>
						<td class="value">
							<input type="checkbox" id="language_type_jp" name="language_type_jp" value="002" <%= language_type_jp %>>日本語<br>
							<input type="checkbox" id="language_type_en" name="language_type_en" value="001" <%= language_type_en %>>英語
						</td>
					</tr>
				</table>
			</div>
			...
			<div class="input_table">
				<table>
					<tr>
						...
						<td class="value">
							<select id="id_sort_order"name="sort_order" tabindex="10">
